    ...
    (function (t) {
        ...
        (t.active = 0),
            ...
            (t.ajaxSettings = {
                ...
                accepts: { script: 'text/javascript, application/javascript, application/x-javascript', json: u, xml: 'application/xml, text/xml', html: f, text: 'text/plain' },
                crossDomain: !1,
                timeout: 0,
                processData: !0,
                cache: !0,
            ...
            (t.ajax = function (e) {
                ...
                if (
                    ...
                    l('Accept', u || '*/*'),
                    (u = n.mimeType || u) && (u.indexOf(',') > -1 && (u = u.split(',', 2)[0]), d.overrideMimeType && d.overrideMimeType(u)),
