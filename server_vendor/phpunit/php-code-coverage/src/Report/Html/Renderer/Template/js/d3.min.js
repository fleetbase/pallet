!(function () {
        ...
        return (
            (t.on = function (t, i) {
                ...
                return arguments.length < 2
                    ? o && o.on
                    : (o && ((o.on = null), (e = e.slice(0, (u = e.indexOf(o))).concat(e.slice(u + 1))), r.remove(t)), i && e.push(r.set(t, { on: i })), n);
            }),
            t
        );
    }
    ...
    function pn(n, t, e) {
        ...
        return (
            ...
            (r = vn(r) * ta),
            (u = vn(u) * ea),
            new mn(yn(3.2404542 * i - 1.5371385 * r - 0.4985314 * u), yn(-0.969266 * i + 1.8760108 * r + 0.041556 * u), yn(0.0556434 * i - 0.2040259 * r + 1.0572252 * u))
        );
    }
    function gn(n, t, e) {
    ...
    function _n(n, t, e) {
        ...
        return (u = ua.get(n))
            ...
            : (null == n ||
                  ...
                  (4 === n.length
                      ? ((o = (3840 & u) >> 4), (o = (o >> 4) | o), (a = 240 & u), (a = (a >> 4) | a), (l = 15 & u), (l = (l << 4) | l))
                      : 7 === n.length && ((o = (16711680 & u) >> 16), (a = (65280 & u) >> 8), (l = 255 & u))),
              t(o, a, l));
    }
    function wn(n, t, e) {
        var r,
        ...
        return (
            a
                ? ((i = 0.5 > l ? a / (o + u) : a / (2 - o - u)), (r = n == o ? (t - e) / a + (e > t ? 6 : 0) : t == o ? (e - n) / a + 2 : (n - t) / a + 4), (r *= 60))
                : ((r = NaN), (i = l > 0 && 1 > l ? 0 : r)),
            new ln(r, i, l)
        );
    }
    ...
    function Cn(n, t, e, r) {
        ...
        var u = {},
            ...
            c = null;
        return (
            !this.XDomainRequest || 'withCredentials' in l || !/^(http(s)?:)?\/\//.test(n) || (l = new XDomainRequest()),
            'onload' in l
    ...
    function Lt(n, t, e, r, i) {
        ...
        if (
            ...
            for (var f, s, h = u[0]; ; ) {
                ...
                do {
                    if (((p.v = p.o.v = !0), p.e)) {
                        if (g) for (var a = 0, c = f.length; c > a; ++a) i.point((s = f[a])[0], s[1]);
            ...
            var p,
                ...
                m = {
                    ...
                    polygonEnd: function () {
                        ...
                        var n = Ot(y, g);
                        p.length ? (b || (u.polygonStart(), (b = !0)), Lt(p, Ut, n, e, u)) : n && (b || (u.polygonStart(), (b = !0)), u.lineStart(), e(null, null, 1, u), u.lineEnd()),
                            b && (u.polygonEnd(), (b = !1)),
                            (p = g = null);
                    },
                    sphere: function () {
        ...
        return {
            ...
            point: function (u, o) {
                var a = u > 0 ? Fo : -Fo,
                    l = xo(u - e);
                xo(l - Fo) < Uo
                    ? (n.point(e, (r = (r + o) / 2 > 0 ? Io : -Io)), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(a, r), n.point(u, r), (t = 0))
                    : i !== a &&
                      l >= Fo &&
                      (xo(e - i) < Uo && (e -= i * Uo), xo(u - a) < Uo && (u -= a * Uo), (r = Ft(e, r, u, o)), n.point(i, r), n.lineEnd(), n.lineStart(), n.point(a, r), (t = 0)),
                    n.point((e = u), (r = o)),
                    (i = a);
            },
            lineEnd: function () {
        ...
        function e(n) {
            ...
            return {
                ...
                point: function (s, h) {
                    ...
                    if ((!e && (c = l = v) && n.lineStart(), v !== l && ((p = r(e, g)), (wt(e, p) || wt(g, p)) && ((g[0] += Uo), (g[1] += Uo), (v = t(g[0], g[1])))), v !== l))
                        ...
                        d & u ||
                            ...
                            o
                                ...
                                : (n.point(y[1][0], y[1][1]), n.lineEnd(), n.lineStart(), n.point(y[0][0], y[0][1])));
                    }
        ...
        function r(n, t, e) {
            ...
            if (!(0 > M)) {
                ...
                var E = S - w,
                    ...
                    C = A || Uo > E;
                if (
                    (!A && k > N && ((_ = k), (k = N), (N = _)), C ? (A ? (k + N > 0) ^ (b[1] < (xo(b[0] - w) < Uo ? k : N)) : k <= b[1] && b[1] <= N) : (E > Fo) ^ (w <= b[0] && b[0] <= S))
                ) {
                    var z = xt(d, (-y + x) / m);
        ...
        function i(t, e, r, a, l, c, f, s, h, p, g, v, d, y) {
            ...
            if (x > 4 * u && d--) {
                var b = a + p,
                    ...
                    L = C - e,
                    q = M * z - m * L;
                ((q * q) / x > u || xo((m * z + M * L) / x - 0.5) > 0.3 || o > a * p + l * g + c * v) &&
                    (i(t, e, r, a, l, c, A, C, N, (b /= S), (_ /= S), w, d, y), y.point(A, C), i(A, C, N, b, _, w, f, s, h, p, g, v, d, y));
            }
        }
        var u = 0.5,
            o = Math.cos(30 * Yo),
    ...
    function ve(n, t) {
        ...
        return function (i, u, o, a) {
            var l = o * t;
            null != i ? ((i = de(e, i)), (u = de(e, u)), (o > 0 ? u > i : i > u) && (i += o * Ho)) : ((i = n + o * Ho), (u = n - 0.5 * l));
        ...
        return (
            (function c(n, f, s, h, p) {
                if (!(f > u || s > o || r > h || i > p)) {
                    ...
                    for (var M = n.nodes, x = 0.5 * (f + h), b = 0.5 * (s + p), _ = t >= x, w = e >= b, S = (w << 1) | _, k = S + 4; k > S; ++S)
                        if ((n = M[3 & S]))
                            switch (3 & S) {
                                case 0:
                                    c(n, f, s, x, b);
    ...
    function mr(n, t) {
        ...
        for (n += '', t += ''; (e = hl.exec(n)) && (r = pl.exec(t)); )
            (i = r.index) > u && ((i = t.slice(u, i)), a[o] ? (a[o] += i) : (a[++o] = i)),
                (e = e[0]) === (r = r[0]) ? (a[o] ? (a[o] += r) : (a[++o] = r)) : ((a[++o] = null), l.push({ i: o, x: yr(e, r) })),
                (u = pl.lastIndex);
        return (
    ...
    function Lr(n, t) {
        ...
        return (
            ...
            arguments.length ? (e = (t / Ho) * Math.asin(1 / n)) : ((n = 1), (e = t / 4)),
            function (r) {
    ...
    function Rr(n, t) {
        ...
        return (
            ...
            isNaN(u) ? ((u = 0), (e = isNaN(e) ? t.h : e)) : u > 180 ? (u -= 360) : -180 > u && (u += 360),
            function (n) {
    ...
    function Ki(n, t) {
        ...
        var e = Yi(n),
            ...
            u = (t / r) * i;
        return 0.15 >= u ? (i *= 10) : 0.35 >= u ? (i *= 5) : 0.75 >= u && (i *= 2), (e[0] = Math.ceil(e[0] / i) * i), (e[1] = Math.floor(e[1] / i) * i + 0.5 * i), (e[2] = i), e;
    }
    function Qi(n, t) {
    ...
    function ju(n) {
        for (var t, e, r, i, u = [], o = Uu(n), a = -1, l = n.length - 1; ++a < l; )
            (t = Pu(n[a], n[a + 1])),
                xo(t) < Uo ? (o[a] = o[a + 1] = 0) : ((e = o[a] / t), (r = o[a + 1] / t), (i = e * e + r * r), i > 9 && ((i = (3 * t) / Math.sqrt(i)), (o[a] = i * e), (o[a + 1] = i * r)));
    ...
    function Ou(n) {
        function t(t) {
            ...
            for (
                ...
                o.call(this, (h = t[m]), m)
                    ? (d.push([(p = +x.call(this, h, m)), (g = +b.call(this, h, m))]), y.push([+_.call(this, h, m), +w.call(this, h, m)]))
                    : d.length && (l(), (d = []), (y = []));
    ...
    function Bu(n) {
        return function () {
            ...
            (t = this[n]) &&
                (r = t[(e = t.active)]) &&
                ((r.timer.c = null), (r.timer.t = NaN), --t.count ? delete t[e] : delete this[n], (t.active += 0.5), r.event && r.event.interrupt.call(this, this.__data__, r.index));
        };
    }
    function Wu(n, t, e) {
    ...
    (ao.range = function (n, t, e) {
        ...
        var r,
            ...
            u = a(xo(e)),
            o = -1;
        if (((n *= u), (t *= u), (e *= u), 0 > e)) for (; (r = n + e * ++o) > t; ) i.push(r / u);
    ...
    (ao.interpolateZoom = function (n, t) {
        ...
        (ao.behavior.zoom = function () {
            ...
            function p() {
                ...
                m ? clearTimeout(m) : (Il.call(this), (v = e((d = y || ao.mouse(this)))), l(n)),
    ...
    (ia.brighter = function (n) {
        ...
        var t = this.r,
            ...
            i = 30;
        return t || e || r
            ? (t && i > t && (t = i), e && i > e && (e = i), r && i > r && (r = i), new mn(Math.min(255, t / n), Math.min(255, e / n), Math.min(255, r / n)))
            : new mn(i, i, i);
    }),
        (ia.darker = function (n) {
            return (n = Math.pow(0.7, arguments.length ? n : 1)), new mn(n * this.r, n * this.g, n * this.b);
        }),
        (ia.hsl = function () {
    ...
    ao.formatPrefix = function (n, t) {
        ...
        return (
            (n = +n) &&
                (0 > n && (n *= -1), t && (n = ao.round(n, Pn(n, t))), (e = 1 + Math.floor(1e-12 + Math.log(n) / Math.LN10)), (e = Math.max(-24, Math.min(24, 3 * Math.floor((e - 1) / 3))))),
            sa[8 + e / 3]
        );
    };
    var ha = /(?:([^{])?([<>=^]))?([+\- ])?([$#])?(0)?(\d+)?(,)?(\.-?\d+)?([a-z%])?/i,
    ...
    (ao.geo.bounds = (function () {
            ...
            b = {
                ...
                polygonEnd: function () {
                    Na.polygonEnd(),
                        ...
                        (b.lineStart = e),
                        (b.lineEnd = r),
                        0 > ka ? ((f = -(h = 180)), (s = -(p = 90))) : m > Uo ? (p = 90) : -Uo > m && (s = -90),
                        (x[0] = f),
                        (x[1] = h);
                },
            };
        ...
        (ao.geo.centroid = function (n) {
            ...
            var t = Da,
                ...
                r = Ua,
                i = t * t + e * e + r * r;
            return jo > i && ((t = qa), (e = Ta), (r = Ra), Uo > Aa && ((t = Ca), (e = za), (r = La)), (i = t * t + e * e + r * r), jo > i)
                ? [NaN, NaN]
    ...
    (ao.geo.clipExtent = function () {
        var n,
            ...
            o = {
                ...
                extent: function (a) {
                    return arguments.length
                        ? ((u = Zt((n = +a[0][0]), (t = +a[0][1]), (e = +a[1][0]), (r = +a[1][1]))), i && ((i.valid = !1), (i = null)), o)
                        : [
                              [n, t],
                              [e, r],
                          ];
        ...
        (ao.geo.albers = function () {
            return ao.geo.conicEqualArea().rotate([96, 0]).center([-0.6, 38.7]).parallels([29.5, 45.5]).scale(1070);
        }),
            ...
            return (
                (n.invert = function (n) {
                    var t = u.scale(),
                        ...
                        r = (n[0] - e[0]) / t,
                        i = (n[1] - e[1]) / t;
                    return (i >= 0.12 && 0.234 > i && r >= -0.425 && -0.214 > r ? o : i >= 0.166 && 0.234 > i && r >= -0.214 && -0.115 > r ? a : u).invert(n);
                }),
                (n.stream = function (n) {
                    var t = u.stream(n),
                        e = o.stream(n),
                ...
                (n.scale = function (t) {
                    return arguments.length ? (u.scale(t), o.scale(0.35 * t), a.scale(t), n.translate(u.translate())) : u.scale();
                }),
                (n.translate = function (t) {
        ...
        (ao.geo.graticule = function () {
            ...
            return (
                ...
                (n.majorExtent = function (t) {
                    return arguments.length
                        ? ((u = +t[0][0]), (i = +t[1][0]), (c = +t[0][1]), (l = +t[1][1]), u > i && ((t = u), (u = i), (i = t)), c > l && ((t = c), (c = l), (l = t)), n.precision(m))
                        : [
                              [u, c],
                              [i, l],
                          ];
                ...
                (n.minorExtent = function (t) {
                    return arguments.length
                        ? ((r = +t[0][0]), (e = +t[1][0]), (a = +t[0][1]), (o = +t[1][1]), r > e && ((t = r), (r = e), (e = t)), a > o && ((t = a), (a = o), (o = t)), n.precision(m))
                        : [
                              [r, a],
                              [e, o],
                          ];
        ...
        (er.prototype = {
            insert: function (n, t) {
                ...
                for (t.L = t.R = null, t.U = e, t.C = !0, n = t; e && e.C; )
                    (r = e.U),
                        e === r.L
                            ? ((i = r.R), i && i.C ? ((e.C = i.C = !1), (r.C = !0), (n = r)) : (n === e.R && (ir(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ur(this, r)))
                            : ((i = r.L), i && i.C ? ((e.C = i.C = !1), (r.C = !0), (n = r)) : (n === e.L && (ur(this, e), (n = e), (e = n.U)), (e.C = !1), (r.C = !0), ir(this, r))),
                        (e = n.U);
                this._.C = !1;
            },
            remove: function (n) {
                ...
                if (
                    ...
                    u && o
                        ? ((r = e.C), (e.C = n.C), (e.L = u), (u.U = e), e !== o ? ((i = e.U), (e.U = n.U), (n = e.R), (i.L = n), (e.R = o), (o.U = e)) : ((e.U = i), (i = e), (n = e.R)))
                        : ((r = n.C), (n = e)),
                    n && (n.U = i),
                    !r)
                ) {
        ...
        (ao.geom.quadtree = function (n, t, e, r, i) {
            ...
            return (o = arguments.length)
                ...
                : ((u.x = function (n) {
                  ...
                  (u.extent = function (n) {
                      return arguments.length
                          ? (null == n ? (t = e = r = i = null) : ((t = +n[0][0]), (e = +n[0][1]), (r = +n[1][0]), (i = +n[1][1])), u)
                          : null == t
                          ? null
                          : [
                                [t, e],
    ...
    (ao.interpolate = Mr),
        (ao.interpolators = [
            function (n, t) {
                var e = typeof t;
                return (
                    'string' === e ? (ua.has(t.toLowerCase()) || /^(#|rgb\(|hsl\()/i.test(t) ? vr : mr) : t instanceof an ? vr : Array.isArray(t) ? xr : 'object' === e && isNaN(t) ? dr : yr
                )(n, t);
            },
        ]),
    ...
    (ao.interpolateTransform = $r),
        ...
        (ao.layout.force = function () {
            ...
            return (
                ...
                (l.drag = function () {
                    return (
                        r || (r = ao.behavior.drag().origin(m).on('dragstart.force', Qr).on('drag.force', t).on('dragend.force', ni)),
                    ...
                    for (n(h, (c.dx * c.dy) / e.value), f.area = 0; (l = h.length) > 0; )
                        f.push((o = h[l - 1])),
                            ...
                            'squarify' !== p || (a = r(f, v)) <= g
                                ? (h.pop(), (g = a))
                                : ((f.area -= f.pop().area), i(f, v, c, !1), (v = Math.min(c.dx, c.dy)), (f.length = f.area = 0), (g = 1 / 0));
    ...
    var Al = [2062260, 16744206, 2924588, 14034728, 9725885, 9197131, 14907330, 8355711, 12369186, 1556175].map(xn),
        Cl = [
            2062260, 11454440, 16744206, 16759672, 2924588, 10018698, 14034728, 16750742, 9725885, 12955861, 9197131, 12885140, 14907330, 16234194, 8355711, 13092807, 12369186, 14408589,
            1556175, 10410725,
        ].map(xn),
        zl = [
            3750777, 5395619, 7040719, 10264286, 6519097, 9216594, 11915115, 13556636, 9202993, 12426809, 15186514, 15190932, 8666169, 11356490, 14049643, 15177372, 8077683, 10834324,
            13528509, 14589654,
        ].map(xn),
        Ll = [
            3244733, 7057110, 10406625, 13032431, 15095053, 16616764, 16625259, 16634018, 3253076, 7652470, 10607003, 13101504, 7695281, 10394312, 12369372, 14342891, 6513507, 9868950,
            12434877, 14277081,
        ].map(xn);
            ...
            function n() {
                ...
                if (
                    ((y = (+l.apply(this, arguments) || 0) / 2) &&
                        ((d = u === ql ? Math.sqrt(n * n + c * c) : +u.apply(this, arguments)), p || (E *= -1), c && (E = tn((d / c) * Math.sin(y))), n && (N = tn((d / n) * Math.sin(y)))),
                    c)
                ) {
                ...
                if (h > Uo && (g = Math.min(Math.abs(c - n) / 2, +i.apply(this, arguments))) > 0.001) {
                    v = (c > n) ^ p ? 0 : 1;
                    var T = g,
                        R = g;
                    if (Fo > h) {
                    ...
                    if (
                        ('bottom' === r || 'top' === r
                            ? ((n = no),
                              ...
                              _.attr('d', 'M' + x[0] + ',' + q * u + 'V0H' + x[1] + 'V' + q * u))
                            : ((n = to),
                              (w = 'y'),
                              (k = 'x'),
                              (S = 'y2'),
        ...
        function u() {
            ...
            function d() {
                var n = ao.mouse(b),
                    t = !1;
                x && ((n[0] += x[0]), (n[1] += x[1])),
                    C || (ao.event.altKey ? (M || (M = [(s[0] + s[1]) / 2, (h[0] + h[1]) / 2]), (L[0] = s[+(n[0] < M[0])]), (L[1] = h[+(n[1] < M[1])])) : (M = null)),
                    E && y(n, c, 0) && (r(k), (t = !0)),
                    A && y(n, f, 1) && (i(k), (t = !0)),
            ...
            function y(n, t, e) {
                ...
                return (
                    ...
                    C ? (i = (r += f) + d) : (M && (f = Math.max(l, Math.min(c, 2 * M[e] - r))), r > f ? ((i = r), (r = f)) : (i = f)),
                    v[0] != r || v[1] != i ? (e ? (a = null) : (o = null), (v[0] = r), (v[1] = i), !0) : void 0
                );
            }
            function m() {
                d(),
            ...
            if (
                (ao.event.changedTouches ? q.on('touchmove.brush', d).on('touchend.brush', m) : q.on('mousemove.brush', d).on('mouseup.brush', m),
                ...
                return arguments.length
                    ? (c &&
                      ...
                      f &&
                          ...
                          (i == h[0] && u == h[1]) || (h = [i, u])),
                      n)
                    : (c && (o ? ((e = o[0]), (r = o[1])) : ((e = s[0]), (r = s[1]), c.invert && ((e = c.invert(e)), (r = c.invert(r))), e > r && ((l = e), (e = r), (r = l)))),
                      f && (a ? ((i = a[0]), (u = a[1])) : ((i = h[0]), (u = h[1]), f.invert && ((i = f.invert(i)), (u = f.invert(u))), i > u && ((l = i), (i = u), (u = l)))),
                      c && f
                          ? [
                                [e, i],
                                [r, u],
