    ...
    (a.dev = !1),
            ...
            function b(l) {
                l.each(function (l) {
                    function m() {
                        ...
                        if (
                            (k &&
                                ...
                                d3.event.target.className.baseVal.match('nv-legend') && (j = !0)),
                            i && ((d -= f.left), (e -= f.top)),
                            0 > d || 0 > e || d > o || e > p || (d3.event.relatedTarget && void 0 === d3.event.relatedTarget.ownerSVGElement) || j)
                        ) {
                            if (
                                k &&
                                d3.event.relatedTarget &&
                                void 0 === d3.event.relatedTarget.ownerSVGElement &&
                                (void 0 === d3.event.relatedTarget.className || d3.event.relatedTarget.className.match(c.nvPointerEventsClass))
                            )
                                return;
                            return h.elementMouseout({ mouseX: d, mouseY: e }), b.renderGuideLine(null), void c.hidden(!0);
                        }
                        c.hidden(!1);
                        var l = g.invert(d);
                        h.elementMousemove({ mouseX: d, mouseY: e, pointXValue: l }),
                            'dblclick' === d3.event.type && h.elementDblclick({ mouseX: d, mouseY: e, pointXValue: l }),
                            'click' === d3.event.type && h.elementClick({ mouseX: d, mouseY: e, pointXValue: l });
                    }
                    ...
                    r.append('g').attr('class', 'nv-interactiveGuideLine'),
                        j &&
                            (j.on('touchmove', m).on('mousemove', m, !0).on('mouseout', m, !0).on('dblclick', m).on('click', m),
                            (b.guideLine = null),
                            (b.renderGuideLine = function (c) {
                                i &&
                                    ((b.guideLine && b.guideLine.attr('x1') === c) ||
                                        a.dom.write(function () {
                                            var b = q
                                                .select('.nv-interactiveGuideLine')
                                                .selectAll('line')
                                                .data(null != c ? [a.utils.NaNtoZero(c)] : [], String);
                                            b
                                                .enter()
                                                .append('line')
                    ...
                    if (!n) {
                        ...
                        (a = k ? k : document.body),
                            (n = d3
                                .select(a)
                                .append('div')
                                .attr('class', 'nvtooltip ' + (j ? j : 'xy-tooltip'))
                                .attr('id', v)),
                                ...
                                b && (o.innerHTML = b),
                                    k && u
                                        ? a.dom.read(function () {
                                              ...
                                              (f += k.offsetLeft + b.left - 2 * k.scrollLeft),
                                                  (g += k.offsetTop + b.top - 2 * k.scrollTop),
                                                  h && h > 0 && (g = Math.floor(g / h) * h),
                                                  C([f, g]);
                                          })
                                        : C([f, g]);
                            }),
                        ...
                        o &&
                            a.dom.read(function () {
                                ...
                                var r,
                                    ...
                                    u = function (a) {
                                        var b = d;
                                        do isNaN(a.offsetTop) || (b += a.offsetTop), (a = a.offsetParent);
                                        while (a);
                                        return b;
                                    },
                                    v = function (a) {
                                        var b = c;
                                        do isNaN(a.offsetLeft) || (b += a.offsetLeft), (a = a.offsetParent);
                                        while (a);
                                        return b;
                                    };
                                switch (f) {
                                ...
                                l
                                    ? n.transition().delay(m).duration(0).style('opacity', 0)
                                    : n
                                          .interrupt()
                                          .transition()
                                          .duration(A ? 0 : s)
                    ...
                    (d._options = Object.create(
                        {},
                        {
                            ...
                            data: {
                                ...
                                set: function (a) {
                                    a.point && ((a.value = a.point.x), (a.series = a.series || {}), (a.series.value = a.point.y), (a.series.color = a.point.color || a.series.color)),
                                        (e = a);
                                },
                            },
                            tooltipElem: {
        ...
        (a.utils.windowSize = function () {
            ...
            return window.innerWidth && window.innerHeight
                ...
                ? ((a.width = document.documentElement.offsetWidth), (a.height = document.documentElement.offsetHeight), a)
                : document.body && document.body.offsetWidth
                ? ((a.width = document.body.offsetWidth), (a.height = document.body.offsetHeight), a)
                : a;
        }),
        (a.utils.windowResize = function (b) {
            return (
                window.addEventListener ? window.addEventListener('resize', b) : a.log('ERROR: Failed to bind to window.resize with: ', b),
                {
                    callback: b,
                    clear: function () {
        ...
        (a.utils.renderWatch = function (b, c) {
            ...
            (this.models = function (a) {
                ...
                (this.transition = function (a, b, c) {
                    if (
                        ((b = arguments.length > 1 ? [].slice.call(arguments, 1) : []),
        ...
        (a.models.axis = function () {
            ...
            function b(g) {
                return (
                    ...
                    g.each(function (b) {
                        ...
                        switch (c.orient()) {
                            case 'top':
                                v.enter().append('text').attr('class', 'nv-axislabel'),
                                    (y = d.range().length < 2 ? 0 : 2 === d.range().length ? d.range()[1] : d.range()[d.range().length - 1] + (d.range()[1] - d.range()[0])),
                                    v
                                        .attr('text-anchor', 'middle')
                                        .attr('y', 0)
                                        .attr('x', y / 2),
                                    i &&
                                        ((x = p.selectAll('g.nv-axisMaxMin').data(d.domain())),
                                        x
                                            .enter()
                                            .append('g')
                            ...
                            case 'bottom':
                                ...
                                v.enter().append('text').attr('class', 'nv-axislabel'),
                                    ...
                                    v
                                        ...
                                        .attr('x', y / 2),
                                    i &&
                                        ((x = p.selectAll('g.nv-axisMaxMin').data([d.domain()[0], d.domain()[d.domain().length - 1]])),
                                        x
                                            .enter()
                                            .append('g')
                                            .attr('class', function (a, b) {
                                        ...
                                        x
                                            ...
                                            .attr('y', c.tickPadding())
                                            .attr('transform', C)
                                            .style('text-anchor', j ? (j % 360 > 0 ? 'start' : 'end') : 'middle')
                                            .text(function (a) {
                                                var b = u(a);
                                                return ('' + b).match('NaN') ? '' : b;
                                            }),
                            ...
                            case 'right':
                                v.enter().append('text').attr('class', 'nv-axislabel'),
                                    v
                                        .style('text-anchor', k ? 'middle' : 'begin')
                                        .attr('transform', k ? 'rotate(90)' : '')
                                        .attr('y', k ? -Math.max(e.right, f) + 12 : -10)
                            ...
                            case 'left':
                                v.enter().append('text').attr('class', 'nv-axislabel'),
                                    v
                                        .style('text-anchor', k ? 'middle' : 'end')
                                        .attr('transform', k ? 'rotate(-90)' : '')
                        ...
                        if (
                            ...
                            !i ||
                                ('left' !== c.orient() && 'right' !== c.orient()) ||
                                (t.selectAll('g').each(function (a) {
                                    d3.select(this).select('text').attr('opacity', 1),
                                        (d(a) < d.range()[1] + 10 || d(a) > d.range()[0] - 10) &&
                                            ((a > 1e-10 || -1e-10 > a) && d3.select(this).attr('opacity', 0), d3.select(this).select('text').attr('opacity', 0));
                                }),
                                d.domain()[0] == d.domain()[1] &&
                                    0 == d.domain()[0] &&
                                    p.selectAll('g.nv-axisMaxMin').style('opacity', function (a, b) {
                                        return b ? 0 : 1;
                                    })),
            ...
            return (
                ...
                a.utils.inheritOptionsD3(b, c, ['orient', 'tickValues', 'tickSubdivide', 'tickSize', 'tickPadding', 'tickFormat']),
                    ...
                    l.each(function (b) {
                        ...
                        if (!d) {
                            var x = d3.min(
                                    b.map(function (a) {
                                        ...
                                        return (
                                            b.push(a.values.Q1),
                                            a.values.hasOwnProperty('whisker_low') && null !== a.values.whisker_low && b.push(a.values.whisker_low),
                                            a.values.hasOwnProperty('outliers') && null !== a.values.outliers && (b = b.concat(a.values.outliers)),
                                            d3.min(b)
                                        );
                                    })
                                ),
                                y = d3.max(
                                    b.map(function (a) {
                                        ...
                                        return (
                                            b.push(a.values.Q3),
                                            a.values.hasOwnProperty('whisker_high') && null !== a.values.whisker_high && b.push(a.values.whisker_high),
                                            a.values.hasOwnProperty('outliers') && null !== a.values.outliers && (b = b.concat(a.values.outliers)),
                                            d3.max(b)
                                        );
                                    })
                        ...
                        A.attr('class', 'nv-boxplot')
                            .attr('transform', function (a, b) {
                                return 'translate(' + (m(o(a, b)) + 0.05 * m.rangeBand()) + ', 0)';
                            })
                            ...
                            B.each(function (a, b) {
                                ...
                                ['low', 'high'].forEach(function (d) {
                                    a.values.hasOwnProperty('whisker_' + d) &&
                                        ...
                                        (c
                                            .append('line')
                                            .style('stroke', a.color ? a.color : q(a, b))
                                            .attr('class', 'nv-boxplot-whisker nv-boxplot-' + d),
                                        c
                                            .append('line')
                                            .style('stroke', a.color ? a.color : q(a, b))
                                            .attr('class', 'nv-boxplot-tick nv-boxplot-' + d));
                                });
                            });
                        ...
                        C.enter()
                            ...
                            C.watchTransition(v, 'nv-boxplot: nv-boxplot-outlier')
                                ...
                                .on('mouseover', function (a, b) {
                                    d3.select(this).classed('hover', !0),
                                        s.elementMouseover({
                                            ...
                                            value: a.label,
                                            series: [
                                                { key: 'Q3', value: a.values.Q3, color: a.color || q(a, b) },
                                                { key: 'Q2', value: a.values.Q2, color: a.color || q(a, b) },
                ...
                return (
                    ...
                    k.each(function (k) {
                        ...
                        if (
                            ...
                            return (
                                v.enter().append('text').attr('class', 'nvd3 nv-noData').attr('dy', '-.7em').style('text-anchor', 'middle'),
                                v
                                    .attr('x', h.left + t / 2)
                                    .attr('y', h.top + u / 2)
                                    .text(function (a) {
                        ...
                        x.append('g').attr('class', 'nv-x nv-axis'),
                            x.append('g').attr('class', 'nv-y nv-axis').append('g').attr('class', 'nv-zeroLine').append('line'),
                            x.append('g').attr('class', 'nv-barsWrap'),
                            z.attr('transform', 'translate(' + h.left + ',' + h.top + ')'),
                            n && z.select('.nv-y.nv-axis').attr('transform', 'translate(' + t + ',0)'),
                            e.width(t).height(u);
                        ...
                        if (
                            ...
                            f
                                ...
                                .tickSize(-u, 0),
                                z.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + d.range()[0] + ')'),
                                z.select('.nv-x.nv-axis').call(f);
                            var B = z.select('.nv-x.nv-axis').selectAll('g');
                            o &&
                                B.selectAll('text').attr('transform', function (a, b, c) {
                ...
                return (
                    d.each(function (b, d) {
                        ...
                        F.append('rect').attr('class', 'nv-range nv-rangeMax'),
                            F.append('rect').attr('class', 'nv-range nv-rangeAvg'),
                            F.append('rect').attr('class', 'nv-range nv-rangeMin'),
                            F.append('rect').attr('class', 'nv-measure'),
                            D.attr('transform', 'translate(' + c.left + ',' + c.top + ')');
                        var H = function (a) {
                        ...
                        G.select('rect.nv-rangeMax')
                            ...
                            .attr('x', I(B > 0 ? B : A))
                            .datum(B > 0 ? B : A),
                            G.select('rect.nv-rangeAvg').attr('height', s).attr('width', H(C)).attr('x', I(C)).datum(C),
                            ...
                            G.select('rect.nv-measure')
                                ...
                                .attr('height', s / 3)
                                .attr('y', s / 3)
                                .attr('width', 0 > v ? z(0) - z(v[0]) : z(v[0]) - z(0))
                                .attr('x', I(v))
                ...
                return (
                    d.each(function (e, o) {
                        ...
                        var B = x
                            ...
                            .append('g')
                            .attr('text-anchor', 'end')
                            .attr('transform', 'translate(-6,' + (l - g.top - g.bottom) / 2 + ')');
                        B.append('text')
                            .attr('class', 'nv-title')
                            .text(function (a) {
                                return a.title;
                ...
                return (
                    x.each(function (b) {
                        ...
                        l.domain(d || d3.extent(b[0].values.map(n).concat(t))),
                            l.range(v ? f || [(0.5 * x) / b[0].values.length, (x * (b[0].values.length - 0.5)) / b[0].values.length] : f || [5 + A / 2, x - A / 2 - 5]),
                            m.domain(e || [d3.min(b[0].values.map(s).concat(u)), d3.max(b[0].values.map(r).concat(u))]).range(g || [y, 0]),
                            l.domain()[0] === l.domain()[1] && l.domain(l.domain()[0] ? [l.domain()[0] - 0.01 * l.domain()[0], l.domain()[1] + 0.01 * l.domain()[1]] : [-1, 1]),
                            m.domain()[0] === m.domain()[1] && m.domain(m.domain()[0] ? [m.domain()[0] + 0.01 * m.domain()[0], m.domain()[1] - 0.01 * m.domain()[1]] : [-1, 1]);
                ...
                return (
                    ...
                    l.each(function (l) {
                        ...
                        if ((L.selectAll('.nv-noData').remove(), (d = f.xScale()), (e = f.yScale()), w)) f.yDomain(null);
                            ...
                            var R = l
                                    ...
                                    .map(function (a) {
                                        ...
                                        return b[0] < -0.95 && (b[0] = -0.95), [(b[0] - b[1]) / (1 + b[1]), (b[1] - b[0]) / (1 + b[0])];
                                    }),
                                S = [
                                    d3.min(R, function (a) {
                                        return a[0];
                        ...
                        if (
                            ...
                            V.append('g').attr('class', 'nv-x nv-axis').style('pointer-events', 'none'),
                            V.append('g').attr('class', 'nv-y nv-axis'),
                            V.append('g').attr('class', 'nv-background'),
                            V.append('g').attr('class', 'nv-linesWrap').style('pointer-events', T),
                            V.append('g').attr('class', 'nv-avgLinesWrap').style('pointer-events', 'none'),
                            V.append('g').attr('class', 'nv-legendWrap'),
                            V.append('g').attr('class', 'nv-controlsWrap'),
                            q &&
                                (i.width(N),
                                W.select('.nv-legendWrap').datum(l).call(i),
                                m.top != i.height() && ((m.top = i.height()), (O = a.utils.availableHeight(p, L, m))),
                                W.select('.nv-legendWrap').attr('transform', 'translate(0,' + -m.top + ')')),
                            u)
                        ) {
                            var X = [{ key: 'Re-scale y-axis', disabled: !w }];
                            j.width(140).color(['#444', '#444', '#444']).rightAlign(!1).margin({ top: 5, right: 0, bottom: 5, left: 20 }),
                        ...
                        U.select('.tempDisabled').remove(),
                            ...
                            v && (k.width(N).height(O).margin({ left: m.left, top: m.top }).svgContainer(L).xScale(d), U.select('.nv-interactive').call(k)),
                            V.select('.nv-background').append('rect'),
                            W.select('.nv-background rect').attr('width', N).attr('height', O),
                            f
                                .y(function (a) {
                                    return a.display.y;
                                })
                        ...
                        bb
                            ...
                            W.select('.nv-background rect').on('click', function () {
                            ...
                            k.dispatch.on('elementMousemove', function (c) {
                                    ...
                                    (l
                                        ...
                                        .forEach(function (g, h) {
                                            ...
                                            'undefined' != typeof k &&
                                                ...
                                                'undefined' == typeof i && (i = b.xScale()(b.x()(k, e))),
                                                j.push({ key: g.key, value: b.y()(k, e), color: n(g, g.seriesIndex) }));
                                        }),
                                    j.length > 2)
                                ) {
                                ...
                                k.tooltip
                                    .position({ left: i + m.left, top: c.mouseY + m.top })
                            ...
                            C.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    'undefined' != typeof a.index && ((G.i = a.index), (G.x = F(G.i)), (y.index = a.index), bb.data([G])),
                        ...
                        return -0.95 > d && !E
                            ...
                            : ((b.tempDisabled = !1),
                              (b.values = b.values.map(function (a, b) {
                                  return (a.display = { y: (K(a, b) - d) / (1 + d) }), a;
                              })),
                              b);
                    })
                );
                ...
                return (
                    ...
                    m.each(function (b) {
                        ...
                        n
                            ...
                            o.range(t ? g || [x - (o.domain()[0] < 0 ? 12 : 0), o.domain()[1] > 0 ? 12 : 0] : g || [x, 0]),
                            (h = h || n),
                        ...
                        var F = E.enter()
                            .append('g')
                            .attr('transform', function (a, b) {
                                return 'translate(' + (n(p(a, b)) + 0.05 * n.rangeBand()) + ', ' + o(0) + ')';
                            })
                            .on('mouseover', function (a, b) {
                            ...
                            .on('click', function (a, b) {
                                v.elementClick({ data: a, index: b, color: d3.select(this).style('fill') }), d3.event.stopPropagation();
                            })
                        ...
                        F.append('rect')
                            ...
                            t
                                ? (F.append('text').attr('text-anchor', 'middle'),
                                  E.select('text')
                                      .text(function (a, b) {
                                          return u(q(a, b));
                                      })
                ...
                return (
                    ...
                    h.each(function (h) {
                        ...
                        v.append('g').attr('class', 'nv-x nv-axis'),
                            v.append('g').attr('class', 'nv-y nv-axis').append('g').attr('class', 'nv-zeroLine').append('line'),
                            v.append('g').attr('class', 'nv-barsWrap'),
                            x.attr('transform', 'translate(' + i.left + ',' + i.top + ')'),
                            o && x.select('.nv-y.nv-axis').attr('transform', 'translate(' + q + ',0)'),
                            e.width(q).height(t);
                        ...
                        if (
                            ...
                            f
                                ...
                                .tickSize(-t, 0),
                                x.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + (d.range()[0] + (e.showValues() && d.domain()[0] < 0 ? 16 : 0)) + ')'),
                                x.select('.nv-x.nv-axis').call(f);
                            var z = x.select('.nv-x.nv-axis').selectAll('g');
                            p &&
                                z.selectAll('text').attr('transform', function (a, b, c) {
                                    return 'translate(0,' + (c % 2 == 0 ? '5' : '17') + ')';
                                });
                        }
                        n &&
                            ...
                            x.select('.nv-zeroLine line').attr('x1', 0).attr('x2', q).attr('y1', d(0)).attr('y2', d(0));
                    }),
                ...
                return (
                    ...
                    k.each(function (b) {
                        ...
                        r
                            ...
                            m
                                .transition(q.exit().selectAll('line.nv-dist' + g), 'dist exit')
                                .attr(g + '1', function (a, b) {
                                    return j(h(a, b));
                                })
                                .attr(g + '2', function (a, b) {
                ...
                (b.margin = function (a) {
                    return arguments.length
                        ? ((d.top = 'undefined' != typeof a.top ? a.top : d.top),
                          (d.right = 'undefined' != typeof a.right ? a.right : d.right),
                          (d.bottom = 'undefined' != typeof a.bottom ? a.bottom : d.bottom),
                          (d.left = 'undefined' != typeof a.left ? a.left : d.left),
                          b)
                        : d;
                }),
                (b.width = function (a) {
                ...
                return (
                    p.each(function (b) {
                        ...
                        if ('classic' == o) x.append('circle').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('r', 5), (v = w.select('circle'));
                            ...
                            x.append('rect').style('stroke-width', 2).attr('class', 'nv-legend-symbol').attr('rx', 3).attr('ry', 3),
                                (v = w.select('rect')),
                                x
                                    .append('g')
                                    ...
                                    if ('classic' == o)
                                        ...
                                        if (m)
                                            (a.disengaged = !a.disengaged),
                                                (a.userDisabled = void 0 == a.userDisabled ? !!a.disabled : a.userDisabled),
                            ...
                            .on('dblclick', function (a, b) {
                                if (('furious' != o || !m) && (n.legendDblclick(a, b), k)) {
                                    ...
                                    c.forEach(function (a) {
                                        ...
                                        (a.disabled = !1),
                                        'furious' == o && (a.userDisabled = a.disabled),
                                        n.stateChange({
                                            disabled: c.map(function (a) {
                                                return !!a.disabled;
                                            }),
                        ...
                        if (h) {
                            ...
                            w.attr('transform', function (a, b) {
                                ...
                                j ? u.attr('transform', 'translate(' + (d - c.right - D) + ',' + c.top + ')') : u.attr('transform', 'translate(0,' + c.top + ')'),
                                (e = c.top + c.bottom + Math.ceil(B.length / C) * A);
                        } else {
                            var J,
                                K = 5,
                                L = 5,
                            ...
                            w.attr('transform', function () {
                                ...
                                u.attr('transform', 'translate(' + (d - c.right - M) + ',' + c.top + ')'),
                ...
                return (
                    x.each(function (b) {
                        ...
                        a.utils.initSVG(k),
                            ...
                            l.range(r ? e || [(0.5 * x) / b[0].values.length, (x * (b[0].values.length - 0.5)) / b[0].values.length] : e || [0, x]),
                            m.domain(d || d3.extent(b[0].values.map(o).concat(q))).range(f || [y, 0]),
                            l.domain()[0] === l.domain()[1] && l.domain(l.domain()[0] ? [l.domain()[0] - 0.01 * l.domain()[0], l.domain()[1] + 0.01 * l.domain()[1]] : [-1, 1]),
                            m.domain()[0] === m.domain()[1] && m.domain(m.domain()[0] ? [m.domain()[0] + 0.01 * m.domain()[0], m.domain()[1] - 0.01 * m.domain()[1]] : [-1, 1]);
                        var z = k.selectAll('g.nv-wrap.nv-historicalBar-' + j).data([b[0].values]),
                            A = z
                                .enter()
                                .append('g')
                                .attr('class', 'nvd3 nv-wrap nv-historicalBar-' + j),
                            B = A.append('defs'),
                            C = A.append('g'),
                            D = z.select('g');
                        ...
                        E.exit().remove(),
                            E.enter()
                                ...
                                .attr('transform', function (a, c) {
                                    return 'translate(' + (l(n(a, c)) - (x / b[0].values.length) * 0.45) + ',0)';
                                })
                                .on('mouseover', function (a, b) {
                    ...
                    b.each(function (k) {
                        ...
                        F.append('g').attr('class', 'nv-x nv-axis'),
                            ...
                            p &&
                                ...
                                l.top != i.height() && ((l.top = i.height()), (C = a.utils.availableHeight(o, w, l))),
                                E.select('.nv-legendWrap').attr('transform', 'translate(0,' + -l.top + ')')),
                            E.attr('transform', 'translate(' + l.left + ',' + l.top + ')'),
                            s && G.select('.nv-y.nv-axis').attr('transform', 'translate(' + B + ',0)'),
                            t && (j.width(B).height(C).margin({ left: l.left, top: l.top }).svgContainer(w).xScale(d), E.select('.nv-interactive').call(j)),
                            f
                                .width(B)
                                .height(C)
                                .color(
                        ...
                        H.transition().call(f),
                            ...
                            j.dispatch.on('elementMousemove', function (b) {
                                ...
                                k.filter(function (a, b) {
                                    ...
                                    void 0 !== h &&
                                        (void 0 === d && (d = h),
                                        void 0 === i && (i = c.xScale()(c.x()(h, e))),
                                        n.push({ key: g.key, value: c.y()(h, e), color: m(g, g.seriesIndex), data: g.values[e] }));
                                });
                                var o = g.tickFormat()(c.x()(d, e));
                                j.tooltip
                                    .position({ left: i + l.left, top: b.mouseY + l.top })
                    ...
                    p.each(function (b) {
                        ...
                        if (h) {
                            ...
                            y.attr('transform', function (a, b) {
                                ...
                                j ? v.attr('transform', 'translate(' + (d - c.right - C) + ',' + c.top + ')') : v.attr('transform', 'translate(0,' + c.top + ')'),
                                (e = c.top + c.bottom + Math.ceil(D.length / E) * x);
                        } else {
                            var K,
                                L = 5,
                                M = 5,
                            ...
                            y.attr('transform', function () {
                                var a = d3.select(this).select('text').node().getComputedTextLength() + i;
                                return (
                                    (K = M), d < c.left + c.right + K + a && ((M = K = 5), (L += x)), (M += a), M > N && (N = M), K + N > C && (C = K + N), 'translate(' + K + ',' + L + ')'
                                );
                            }),
                                v.attr('transform', 'translate(' + (d - c.right - N) + ',' + c.top + ')'),
                        ...
                        if ('furious' == o) {
                            w
                                ...
                                .attr('y', -9)
                                .attr('x', -15),
                                u.insert('rect', ':first-child').attr('class', 'nv-legend-bg').attr('fill', '#eee').attr('opacity', 0);
                    ...
                    j.each(function (j) {
                        ...
                        F.append('rect').style('opacity', 0),
                            ...
                            o &&
                                ...
                                k.top != h.height() && ((k.top = h.height()), (C = a.utils.availableHeight(n, v, k))),
                                E.select('.nv-legendWrap').attr('transform', 'translate(0,' + -k.top + ')')),
                            E.attr('transform', 'translate(' + k.left + ',' + k.top + ')'),
                            r && G.select('.nv-y.nv-axis').attr('transform', 'translate(' + B + ',0)'),
                            s && (i.width(B).height(C).margin({ left: k.left, top: k.top }).svgContainer(v).xScale(c), E.select('.nv-interactive').call(i)),
                            e
                                .width(B)
                                .height(C)
                                .color(
                        ...
                        H.call(e),
                            p &&
                                (f
                                    ...
                                    .tickSize(-C, 0),
                                G.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + d.range()[0] + ')'),
                            ...
                            i.dispatch.on('elementMousemove', function (c) {
                                ...
                                if (
                                    (j
                                        ...
                                        .forEach(function (f, g) {
                                            ...
                                            var i = f.values[h],
                                                j = b.y()(i, h);
                                            null != j && e.highlightPoint(g, h, !0),
                                                void 0 !== i &&
                                                    (void 0 === d && (d = i), void 0 === m && (m = b.xScale()(b.x()(i, h))), n.push({ key: f.key, value: j, color: l(f, f.seriesIndex) }));
                                        }),
                                    n.length > 2)
                                ) {
                                    var o = b.yScale().invert(c.mouseY),
                                ...
                                i.tooltip
                                    .position({ left: c.mouseX + k.left, top: c.mouseY + k.top })
            ...
            function b(v) {
                return (
                    v.each(function (v) {
                        ...
                        function S() {
                            u.empty() || u.extent(I),
                                kb.data([u.empty() ? e.domain() : I]).each(function (a) {
                        ...
                        function T() {
                            ...
                            (d = Z.length ? l.xScale() : j.xScale()),
                                ...
                                db.select('.nv-x.nv-axis').transition().duration(L).call(n),
                                b.transition().duration(L).call(l),
                                h.transition().duration(L).call(j),
                                db.select('.nv-focus .nv-x.nv-axis').attr('transform', 'translate(0,' + f.range()[0] + ')'),
                                p
                                    .scale(f)
                                ...
                                db.select('.nv-focus .nv-y1.nv-axis').style('opacity', Z.length ? 1 : 0),
                                db
                                    .select('.nv-focus .nv-y2.nv-axis')
                                    .style('opacity', $.length && !$[0].disabled ? 1 : 0)
                                    .attr('transform', 'translate(' + d.range()[1] + ',0)'),
                                db.select('.nv-focus .nv-y1.nv-axis').transition().duration(L).call(p),
                                db.select('.nv-focus .nv-y2.nv-axis').transition().duration(L).call(q);
                        }
                        ...
                        d.range([0, V]),
                            e
                                .domain(
                                    d3.extent(d3.merge(_.concat(ab)), function (a) {
                                        return a.x;
                                    })
                                )
                                .range([0, V]);
                        ...
                        if (
                            ...
                            t.width(gb),
                                db
                                    ...
                                    .call(t),
                                w.top != t.height() && ((w.top = t.height()), (W = a.utils.availableHeight(z, U, w) - H)),
                                db.select('.nv-legendWrap').attr('transform', 'translate(' + hb + ',' + -w.top + ')');
                        }
                        bb.attr('transform', 'translate(' + w.left + ',' + w.top + ')'),
                            db.select('.nv-context').style('display', E ? 'initial' : 'none'),
                            m
                                .width(V)
                                .height(X)
                                .color(
                        ...
                        var ib = db.select('.nv-context .nv-barsWrap').datum(Z.length ? Z : [{ values: [] }]),
                            jb = db.select('.nv-context .nv-linesWrap').datum($[0].disabled ? [{ values: [] }] : $);
                        db.select('.nv-context').attr('transform', 'translate(0,' + (W + w.bottom + x.top) + ')'),
                            ib.transition().call(m),
                            jb.transition().call(k),
                            G &&
                                (o._ticks(a.utils.calcTicksX(V / 100, v)).tickSize(-X, 0),
                                db.select('.nv-context .nv-x.nv-axis').attr('transform', 'translate(0,' + h.range()[0] + ')'),
                                db.select('.nv-context .nv-x.nv-axis').transition().call(o)),
                            F &&
                                (r
                                    .scale(h)
                                    ._ticks(X / 36)
                                ...
                                db.select('.nv-context .nv-y1.nv-axis').transition().call(r),
                                db.select('.nv-context .nv-y2.nv-axis').transition().call(s)),
                            u.x(e).on('brush', T),
                            I && u.extent(I);
                        var kb = db
                        ...
                        lb.append('rect').attr('class', 'left').attr('x', 0).attr('y', 0).attr('height', X),
                            lb.append('rect').attr('class', 'right').attr('x', 0).attr('y', 0).attr('height', X);
            ...
            function b(o) {
                return (
                    o.each(function (o) {
                        ...
                        function G() {
                            n.empty() || n.extent(y),
                                U.data([n.empty() ? e.domain() : y]).each(function (a) {
                        ...
                        function H() {
                            ...
                            if (!(Math.abs(a[0] - a[1]) <= 1)) {
                                ...
                                var b = Q.select('.nv-focus .nv-linesWrap').datum(
                                    o
                                        .filter(function (a) {
                                            return !a.disabled;
                                        })
                                ...
                                b.transition().duration(B).call(g),
                                    Q.select('.nv-focus .nv-x.nv-axis').transition().duration(B).call(i),
                                    Q.select('.nv-focus .nv-y.nv-axis').transition().duration(B).call(j);
                            }
                        }
                        ...
                        S.append('g').attr('class', 'nv-x nv-axis'),
                            ...
                            x &&
                                ...
                                q.top != m.height() && ((q.top = m.height()), (L = a.utils.availableHeight(u, I, q) - v)),
                                Q.select('.nv-legendWrap').attr('transform', 'translate(0,' + -q.top + ')')),
                            O.attr('transform', 'translate(' + q.left + ',' + q.top + ')'),
                            w && (p.width(K).height(L).margin({ left: q.left, top: q.top }).svgContainer(I).xScale(c), O.select('.nv-interactive').call(p)),
                            g
                                .width(K)
                                .height(L)
                                .color(
                        ...
                        d3.transition(T).call(h),
                            ...
                            j
                                ...
                                .tickSize(-K, 0),
                            Q.select('.nv-focus .nv-x.nv-axis').attr('transform', 'translate(0,' + L + ')'),
                        ...
                        var U = Q.select('.nv-brushBackground')
                                ...
                                .data([y || n.extent()]),
                            V = U.enter().append('g');
                        V.append('rect').attr('class', 'left').attr('x', 0).attr('y', 0).attr('height', M),
                            V.append('rect').attr('class', 'right').attr('x', 0).attr('y', 0).attr('height', M);
                        ...
                        W.selectAll('rect').attr('height', M),
                            ...
                            k
                                ...
                                ._ticks(a.utils.calcTicksX(K / 100, o))
                                .tickSize(-M, 0),
                            Q.select('.nv-context .nv-x.nv-axis').attr('transform', 'translate(0,' + f.range()[0] + ')'),
                            d3.transition(Q.select('.nv-context .nv-x.nv-axis')).call(k),
                            l
                                .scale(f)
                                ._ticks(a.utils.calcTicksY(M / 36, o))
                                .tickSize(-K, 0),
                            d3.transition(Q.select('.nv-context .nv-y.nv-axis')).call(l),
                            Q.select('.nv-context .nv-x.nv-axis').attr('transform', 'translate(0,' + f.range()[0] + ')'),
                            ...
                            p.dispatch.on('elementMousemove', function (c) {
                                ...
                                if (
                                    (o
                                        ...
                                        .forEach(function (i, j) {
                                            ...
                                            var o = m[f],
                                                p = b.y()(o, f);
                                            null != p && g.highlightPoint(j, f, !0),
                                                void 0 !== o &&
                                                    (void 0 === d && (d = o),
                                                    void 0 === h && (h = b.xScale()(b.x()(o, f))),
                                                    k.push({ key: i.key, value: b.y()(o, f), color: s(i, i.seriesIndex) }));
                                        }),
                                    k.length > 2)
                                ) {
                                ...
                                p.tooltip
                                    .position({ left: c.mouseX + q.left, top: c.mouseY + q.top })
                        ...
                        margin: {
                            ...
                            set: function (a) {
                                (q.top = void 0 !== a.top ? a.top : q.top),
                                    (q.right = void 0 !== a.right ? a.right : q.right),
                                    (q.bottom = void 0 !== a.bottom ? a.bottom : q.bottom),
                                    (q.left = void 0 !== a.left ? a.left : q.left);
                            },
                        },
                        color: {
                            get: function () {
                    ...
                    E.each(function (b) {
                        ...
                        if (
                                ...
                                (x = [
                                    {
                                        values: b[0].values.map(function (a) {
                                            return { x: a.x, y: 0, series: a.series, size: 0.01 };
                                        }),
                                    },
                                ]),
                            u)
                            ...
                            H.forEach(function (a, c) {
                                a.nonStackable
                                    ? ((b[c].nonStackableSeries = G++), (H[c] = b[c]))
                                    : c > 0 &&
                                      H[c - 1].nonStackable &&
                        ...
                        m
                            ...
                            n
                                ...
                                .range(g || [F, 0]),
                            m.domain()[0] === m.domain()[1] && m.domain(m.domain()[0] ? [m.domain()[0] - 0.01 * m.domain()[0], m.domain()[1] + 0.01 * m.domain()[1]] : [-1, 1]),
                            n.domain()[0] === n.domain()[1] && n.domain(n.domain()[0] ? [n.domain()[0] + 0.01 * n.domain()[0], n.domain()[1] - 0.01 * n.domain()[1]] : [-1, 1]),
                            (h = h || m),
                            (i = i || n);
                        ...
                        M.append('g').attr('class', 'nv-groups'),
                            J.attr('transform', 'translate(' + j.left + ',' + j.top + ')'),
                            L.append('clipPath')
                            ...
                            J.select('#nv-edge-clip-' + o + ' rect')
                                .attr('width', E)
                                .attr('height', F),
                            N.attr('clip-path', t ? 'url(#nv-edge-clip-' + o + ')' : '');
                        ...
                        var P = C.transition(O.exit().selectAll('rect.nv-bar'), 'multibarExit', Math.min(100, z))
                            .attr('y', function (a) {
                                var c = i(0) || 0;
                        ...
                        Q.style('fill', function (a, b, c) {
                            ...
                            .on('click', function (a, b) {
                                B.elementClick({ data: a, index: b, color: d3.select(this).style('fill') }), d3.event.stopPropagation();
                            })
                            .on('dblclick', function (a, b) {
                        ...
                        u
                            ? R.attr('y', function (a, c, d) {
                                  ...
                                  .attr('x', function (a, c, d) {
                                      var e = 0;
                                      return (
                                          b[d].nonStackable && ((e = (a.series * m.rangeBand()) / b.length), b.length !== G && (e = (b[d].nonStackableSeries * m.rangeBand()) / (2 * G))), e
                                      );
                                  })
                                  .attr('width', function (a, c, d) {
                                      if (b[d].nonStackable) {
                    ...
                    j.each(function (j) {
                        ...
                        if (
                            ...
                            q &&
                                ...
                                k.top != h.height() && ((k.top = h.height()), (H = a.utils.availableHeight(m, z, k))),
                                L.select('.nv-legendWrap').attr('transform', 'translate(' + B() + ',' + -k.top + ')')),
                            o)
                        ) {
                            var M = [
                        ...
                        J.attr('transform', 'translate(' + k.left + ',' + k.top + ')'),
                            t && L.select('.nv-y.nv-axis').attr('transform', 'translate(' + D + ',0)'),
                            e
                                .disabled(
                                    j.map(function (a) {
                                        return a.disabled;
                        ...
                        if ((N.call(e), r)) {
                            f
                                ...
                                .tickSize(-H, 0),
                                L.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + d.range()[0] + ')'),
                            ...
                            u &&
                                ...
                                w &&
                                    O.selectAll('.tick text')
                                        .attr('transform', 'rotate(' + w + ' 0,0)')
                                        .style('text-anchor', w > 0 ? 'start' : 'end'),
                        ...
                        s &&
                            ...
                            A.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    'undefined' != typeof a.stacked && (e.stacked(a.stacked), (x.stacked = a.stacked), (E = a.stacked)),
                                    b.update();
                            });
                    }),
                ...
                return (
                    ...
                    m.each(function (b) {
                        ...
                        o
                            ...
                            p.range(x && !w ? g || [p.domain()[0] < 0 ? z : 0, m - (p.domain()[1] > 0 ? z : 0)] : g || [0, m]),
                            (h = h || o),
                            (i =
                                i ||
                                d3.scale
                        ...
                        J.enter().append('g').style('stroke-opacity', 1e-6).style('fill-opacity', 1e-6),
                            J.exit().watchTransition(E, 'multibarhorizontal: exit groups').style('stroke-opacity', 1e-6).style('fill-opacity', 1e-6).remove(),
                        ...
                        L.append('rect')
                            ...
                            s(b[0], 0) &&
                                ...
                                K.select('polyline')
                                    ...
                                    .attr('points', function (a, c) {
                                        var d = s(a, c),
                                            e = (0.8 * o.rangeBand()) / (2 * (w ? 1 : b.length));
                                        (d = d.length ? d : [-Math.abs(d), Math.abs(d)]),
                                            (d = d.map(function (a) {
                                                return p(a) - p(0);
                                            }));
                                        var f = [
                            ...
                            x && !w
                                ? (K.select('text')
                                  ...
                                  K.watchTransition(E, 'multibarhorizontal: bars')
                                      .select('text')
                                      .attr('x', function (a, b) {
                ...
                return (
                    ...
                    j.each(function (j) {
                        ...
                        if (
                            ...
                            G.append('g').attr('class', 'nv-y nv-axis').append('g').attr('class', 'nv-zeroLine').append('line'),
                            ...
                            q &&
                                ...
                                k.top != h.height() && ((k.top = h.height()), (D = a.utils.availableHeight(m, w, k))),
                                H.select('.nv-legendWrap').attr('transform', 'translate(' + y() + ',' + -k.top + ')')),
                            o)
                        ) {
                            var I = [
                                { key: p.grouped || 'Grouped', disabled: e.stacked() },
                        ...
                        s &&
                            (g
                                ...
                                .tickSize(-D, 0),
                            H.select('.nv-y.nv-axis').attr('transform', 'translate(0,' + D + ')'),
                            H.select('.nv-y.nv-axis').call(g)),
                            H.select('.nv-zeroLine line').attr('x1', d(0)).attr('x2', d(0)).attr('y1', 0).attr('y2', -D),
                            h.dispatch.on('stateChange', function (a) {
                            ...
                            x.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    (u.disabled = a.disabled)),
                                    'undefined' != typeof a.stacked && (e.stacked(a.stacked), (u.stacked = a.stacked), (t = a.stacked)),
                                    b.update();
                            });
                    }),
                ...
                return (
                    j.each(function (j) {
                        function k(a) {
                            ...
                            (a.value = a.point.x),
                                (a.series = { value: a.point.y, color: a.point.color }),
                                B.duration(100)
                        ...
                        function n(a) {
                            ...
                            (a.value = t.x()(a.data)),
                                (a.series = { value: t.y()(a.data), color: a.color }),
                                B.duration(0)
                                    .valueFormatter(function (a, c) {
                                        return b.tickFormat()(a, c);
                                    })
                        ...
                        if (i) {
                            ...
                            A.width(R),
                                ...
                                P.select('.legendWrap')
                                    ...
                                    .call(A),
                                e.top != A.height() && ((e.top = A.height()), (E = a.utils.availableHeight(h, C, e))),
                                P.select('.legendWrap').attr('transform', 'translate(' + S + ',' + -e.top + ')');
                        }
                        r
                            .width(D)
                            .height(E)
                        ...
                        p
                            .domain(
                                c ||
                                    d3.extent(d3.merge(L).concat(Z), function (a) {
                                        return a.y;
                                    })
                            )
                            .range([0, E]),
                            q
                                .domain(
                                    d ||
                                        d3.extent(d3.merge(M).concat($), function (a) {
                                            return a.y;
                                        })
                                )
                                .range([0, E]),
                            ...
                            v.dispatch.on('elementMouseout.tooltip', function () {
                                B.hidden(!0);
                            }),
                            ...
                            t.dispatch.on('elementMouseout.tooltip', function () {
                                B.hidden(!0);
                            }),
                            ...
                            t.dispatch.on('elementMousemove.tooltip', function () {
                                B.position({ top: d3.event.pageY, left: d3.event.pageX })();
                            }),
                ...
                return (
                    y.each(function (b) {
                        ...
                        l.domain(c || d3.extent(b[0].values.map(n).concat(t))),
                            l.range(v ? e || [(0.5 * y) / b[0].values.length, (y * (b[0].values.length - 0.5)) / b[0].values.length] : e || [5 + B / 2, y - B / 2 - 5]),
            ...
            function b(p) {
                return (
                    p.each(function (b) {
                        function p(a) {
                            return F(
                                h.map(function (b) {
                                    ...
                                    return (
                                        J.length > 0 ? (D.style('display', 'inline'), E.style('display', 'inline')) : (D.style('display', 'none'), E.style('display', 'none')),
                                        [f(b), g[b](a[b])]
                                    );
                                })
                            );
                        ...
                        function s(a) {
                            (m[a] = Math.min(w, Math.max(0, (this.parentNode.__origin__ += d3.event.x)))),
                                M.attr('d', p),
                                h.sort(function (a, b) {
                                    return u(a) - u(b);
                                }),
                        ...
                        function t(a) {
                            delete this.parentNode.__origin__,
                                delete m[a],
                                d3.select(this.parentNode).attr('transform', 'translate(' + f(a) + ')'),
                                M.attr('d', p),
                        ...
                        h.forEach(function (a) {
                            ...
                            return (
                                (y[a] = !1),
                                void 0 === c[0] && ((y[a] = !0), (c[0] = 0), (c[1] = 0)),
                                c[0] === c[1] && ((c[0] = c[0] - 1), (c[1] = c[1] + 1)),
                                (g[a] = d3.scale
                                    .linear()
                                    .domain(c)
                                    .range([0.9 * (x - 12), 0])),
                                (g[a].brush = d3.svg.brush().y(g[a]).on('brush', q)),
                                'name' != a
                            );
                        });
                        var z = v.selectAll('g.nv-wrap.nv-parallelCoordinates').data([b]),
                            ...
                            B = A.append('g'),
                            C = z.select('g');
                        B.append('g').attr('class', 'nv-parallelCoordinates background'),
                            B.append('g').attr('class', 'nv-parallelCoordinates foreground'),
                            B.append('g').attr('class', 'nv-parallelCoordinates missingValuesline'),
                            z.attr('transform', 'translate(' + c.left + ',' + c.top + ')');
                        var D,
                            E,
                        ...
                        (D = z.select('.missingValuesline').selectAll('line').data([K])),
                            D.enter().append('line'),
                            D.exit().remove(),
                            ...
                            (E = z.select('.missingValuesline').selectAll('text').data(['undefined values'])),
                        ...
                        M.enter().append('path'),
                            ...
                            M.on('mouseover', function (a, b) {
                                d3.select(this).classed('hover', !0),
                                    o.elementMouseover({ label: a.name, data: a.data, index: b, pos: [d3.mouse(this.parentNode)[0], d3.mouse(this.parentNode)[1]] });
                            }),
                        ...
                        O.append('g').attr('class', 'nv-parallelCoordinates nv-axis'),
                            O.append('g').attr('class', 'nv-parallelCoordinates-brush'),
                            O.append('text').attr('class', 'nv-parallelCoordinates nv-label'),
                            N.attr('transform', function (a) {
                            ...
                            N.select('.nv-label')
                                ...
                                .text(String)
                                .on('mouseover', function (a) {
                                    o.elementMouseover({ dim: a, pos: [d3.mouse(this.parentNode.parentNode)[0], d3.mouse(this.parentNode.parentNode)[1]] });
                                })
                                .on('mouseout', function (a) {
                ...
                return (
                    ...
                    E.each(function (b) {
                        ...
                        var F = d - c.left - c.right,
                            ...
                            I = [],
                            J = [];
                        if (((i = d3.select(this)), 0 === z.length)) for (var K = H - H / 5, L = y * H, M = 0; M < b[0].length; M++) I.push(K), J.push(L);
                        else
                            (I = z.map(function (a) {
                        ...
                        var N = i.selectAll('.nv-wrap.nv-pie').data(b),
                            O = N.enter()
                                .append('g')
                                .attr('class', 'nvd3 nv-wrap nv-pie nv-chart-' + h),
                            P = O.append('g'),
                            Q = N.select('g'),
                            R = P.append('g').attr('class', 'nv-pie');
                        P.append('g').attr('class', 'nv-pieLabels'),
                            N.attr('transform', 'translate(' + c.left + ',' + c.top + ')'),
                            Q.select('.nv-pie').attr('transform', 'translate(' + F / 2 + ',' + G / 2 + ')'),
                            Q.select('.nv-pieLabels').attr('transform', 'translate(' + F / 2 + ',' + G / 2 + ')'),
                        ...
                        for (var M = 0; M < b[0].length; M++) {
                            ...
                            u !== !1 && (S.startAngle(u), T.startAngle(u)),
                                ...
                                S.cornerRadius && x && (S.cornerRadius(x), T.cornerRadius(x)),
                                B.push(S),
                                C.push(T);
                        }
                        var U = d3.layout
                        ...
                        U.padAngle && v && U.padAngle(v),
                            p &&
                                ...
                                N.select('.nv-pie-title')
                                    ...
                                    .style('font-size', (Math.min(F, G) * y * 2) / (q.length + 2) + 'px')
                                    .attr('dy', '0.35em')
                        ...
                        X.attr('class', 'nv-slice'),
                            X.on('mouseover', function (a, b) {
                                d3.select(this).classed('hover', !0),
                                    r && d3.select(this).select('path').transition().duration(70).attr('d', C[b]),
                                    A.elementMouseover({ data: a.data, index: b, color: d3.select(this).style('fill') });
                            }),
                            X.on('mouseout', function (a, b) {
                                d3.select(this).classed('hover', !1),
                                    r && d3.select(this).select('path').transition().duration(50).attr('d', B[b]),
                                    A.elementMouseout({ data: a.data, index: b });
                            }),
                        ...
                        if (
                            ...
                            for (var Y = [], M = 0; M < b[0].length; M++)
                                Y.push(B[M]),
                                    m ? p && ((Y[M] = d3.svg.arc().outerRadius(B[M].outerRadius())), u !== !1 && Y[M].startAngle(u), w !== !1 && Y[M].endAngle(w)) : p || Y[M].innerRadius(0);
                            W.enter()
                                .append('g')
                                .classed('nv-label', !0)
                                .each(function (a) {
                                    ...
                                    b.attr('transform', function (a, b) {
                                        ...
                                        b.append('rect').style('stroke', '#fff').style('fill', '#fff').attr('rx', 3).attr('ry', 3),
                                        b
                                            .append('text')
                                            .style('text-anchor', t ? ((a.startAngle + a.endAngle) / 2 < Math.PI ? 'start' : 'end') : 'middle')
                                            .style('fill', '#000');
                                });
                            var Z = {},
                                $ = 14,
                            ...
                            W.watchTransition(D, 'pie labels').attr('transform', function (a, b) {
                                ...
                                W.select('.nv-label text')
                                    ...
                                    .text(function (a, b) {
                                        ...
                                        if ('function' == typeof n) d = n(a, b, { key: f(a.data), value: g(a.data), percent: k(c) });
                                        else
                                            switch (n) {
                                                case 'key':
                                                    d = f(a.data);
                        ...
                        margin: {
                            ...
                            set: function (a) {
                                (c.top = 'undefined' != typeof a.top ? a.top : c.top),
                                    ...
                                    (c.bottom = 'undefined' != typeof a.bottom ? a.bottom : c.bottom),
                        ...
                        if ((u.append('g').attr('class', 'nv-pieWrap'), u.append('g').attr('class', 'nv-legendWrap'), i))
                            if ('top' === j)
                                d.width(n).key(c.x()),
                                    ...
                                    f.top != d.height() && ((f.top = d.height()), (o = a.utils.availableHeight(h, k, f))),
                                    t.select('.nv-legendWrap').attr('transform', 'translate(0,' + -f.top + ')');
                            else if ('right' === j) {
                    ...
                    N.each(function (b) {
                        function N() {
                            ...
                            if (M === !0) {
                                ...
                                a.length < 3 &&
                                    (a.push([m.range()[0] - 20, n.range()[0] - 20, null, null]),
                                    a.push([m.range()[1] + 20, n.range()[1] + 20, null, null]),
                                    a.push([m.range()[0] - 20, n.range()[0] + 20, null, null]),
                                    a.push([m.range()[1] + 20, n.range()[1] - 20, null, null]));
                                ...
                                C && f.style('fill', d3.rgb(230, 230, 230)).style('fill-opacity', 0.4).style('stroke-opacity', 1).style('stroke', d3.rgb(200, 200, 200)),
                                    B &&
                                        (U.select('.nv-point-clips').selectAll('clipPath').remove(),
                                ...
                                var k = function (a, c) {
                                    ...
                                    if (void 0 !== d) {
                                        ...
                                        var f = l.node().getBoundingClientRect(),
                                            ...
                                            k = { left: m(p(e, a.point)) + f.left + i + g.left + 10, top: n(q(e, a.point)) + f.top + h + g.top + 10 };
                                        c({ point: e, series: d, pos: k, seriesIndex: a.series, pointIndex: a.point });
                                    }
                                };
                                ...
                                U.select('.nv-groups')
                                    ...
                                    .on('click', function (a, c) {
                                        ...
                                        var d = b[a.series],
                                            e = d.values[c];
                                        L.elementClick({ point: e, series: d, pos: [m(p(e, c)) + g.left, n(q(e, c)) + g.top], seriesIndex: a.series, pointIndex: c });
                                    })
                                    .on('dblclick', function (a, c) {
                                        if (O || !b[a.series]) return 0;
                                        var d = b[a.series],
                                            e = d.values[c];
                                        L.elementDblClick({ point: e, series: d, pos: [m(p(e, c)) + g.left, n(q(e, c)) + g.top], seriesIndex: a.series, pointIndex: c });
                                    })
                                    .on('mouseover', function (a, c) {
                                        if (O || !b[a.series]) return 0;
                                        var d = b[a.series],
                                            e = d.values[c];
                                        L.elementMouseover({ point: e, series: d, pos: [m(p(e, c)) + g.left, n(q(e, c)) + g.top], seriesIndex: a.series, pointIndex: c, color: j(a, c) });
                                    })
                                    .on('mouseout', function (a, c) {
                                        if (O || !b[a.series]) return 0;
                                        var d = b[a.series],
                                            e = d.values[c];
                                        L.elementMouseout({ point: e, series: d, seriesIndex: a.series, pointIndex: c, color: j(a, c) });
                                    });
                        }
                        l = d3.select(this);
                        ...
                        m.domain(
                            ...
                            m.range(y && b[0] ? G || [(R * z + R) / (2 * b[0].values.length), R - (R * (1 + z)) / (2 * b[0].values.length)] : G || [0, R]),
                            n
                                .domain(
                                    F ||
                                        d3.extent(
                            ...
                            o
                                ...
                                .range(J || Q),
                            (K = m.domain()[0] === m.domain()[1] || n.domain()[0] === n.domain()[1]),
                            m.domain()[0] === m.domain()[1] && m.domain(m.domain()[0] ? [m.domain()[0] - 0.01 * m.domain()[0], m.domain()[1] + 0.01 * m.domain()[1]] : [-1, 1]),
                            n.domain()[0] === n.domain()[1] && n.domain(n.domain()[0] ? [n.domain()[0] - 0.01 * n.domain()[0], n.domain()[1] + 0.01 * n.domain()[1]] : [-1, 1]),
                        ...
                        var U = l.selectAll('g.nv-wrap.nv-scatter').data([b]),
                            V = U.enter()
                                .append('g')
                                .attr('class', 'nvd3 nv-wrap nv-scatter nv-chart-' + k),
                            W = V.append('defs'),
                            X = V.append('g'),
                            Y = U.select('g');
                        U.classed('nv-single-point', K),
                            ...
                            U.select('#nv-edge-clip-' + k + ' rect')
                                .attr('width', R)
                                .attr('height', S > 0 ? S : 0),
                            Y.attr('clip-path', A ? 'url(#nv-edge-clip-' + k + ')' : ''),
                            (O = !0);
                        ...
                        Z.enter().append('g').style('stroke-opacity', 1e-6).style('fill-opacity', 1e-6),
                            Z.exit().remove(),
                ...
                return (
                    ...
                    z.each(function (z) {
                        ...
                        var J = m.selectAll('g.nv-wrap.nv-scatterChart').data([z]),
                            K = J.enter()
                                .append('g')
                                .attr('class', 'nvd3 nv-wrap nv-scatterChart nv-chart-' + c.id()),
                            L = K.append('g'),
                            M = J.select('g');
                        if (
                            (L.append('rect').attr('class', 'nvd3 nv-background').style('pointer-events', 'none'),
                            L.append('g').attr('class', 'nv-x nv-axis'),
                            L.append('g').attr('class', 'nv-y nv-axis'),
                            L.append('g').attr('class', 'nv-scatterWrap'),
                            L.append('g').attr('class', 'nv-regressionLinesWrap'),
                            L.append('g').attr('class', 'nv-distWrap'),
                            L.append('g').attr('class', 'nv-legendWrap'),
                            v && M.select('.nv-y.nv-axis').attr('transform', 'translate(' + G + ',0)'),
                            s)
                        ) {
                            var N = G;
                            f.width(N),
                                J.select('.nv-legendWrap').datum(z).call(f),
                                j.top != f.height() && ((j.top = f.height()), (H = a.utils.availableHeight(l, m, j))),
                                J.select('.nv-legendWrap').attr('transform', 'translate(0,' + -j.top + ')');
                        }
                        J.attr('transform', 'translate(' + j.left + ',' + j.top + ')'),
                            c
                                .width(G)
                            ...
                            J.select('.nv-scatterWrap')
                                ...
                                .call(c),
                            J.select('.nv-regressionLinesWrap').attr('clip-path', 'url(#nv-edge-clip-' + c.id() + ')');
                        ...
                        P.enter().append('line').attr('class', 'nv-regLine').style('stroke-opacity', 0),
                            P.filter(function (a) {
                                return a.intercept && a.slope;
                            })
                                .watchTransition(D, 'scatterPlusLineChart: regline')
                                .attr('x1', o.range()[0])
                                .attr('x2', o.range()[1])
                                .attr('y1', function (a) {
                            ...
                            t &&
                                ...
                                M.select('.nv-x.nv-axis')
                                    .attr('transform', 'translate(0,' + p.range()[0] + ')')
                                    .call(d)),
                            u &&
                                (e
                                    .scale(p)
                            ...
                            q &&
                                ...
                                L.select('.nv-distWrap').append('g').attr('class', 'nv-distributionX'),
                            ...
                            r &&
                                ...
                                L.select('.nv-distWrap').append('g').attr('class', 'nv-distributionY'),
                                M.select('.nv-distributionY')
                                    .attr('transform', 'translate(' + (v ? G : -h.size()) + ',0)')
                                    .datum(
                                        z.filter(function (a) {
                                            return !a.disabled;
                                        })
                            ...
                            c.dispatch.on('elementMouseout.tooltip', function (a) {
                                i.hidden(!0),
                                    m.select('.nv-chart-' + c.id() + ' .nv-series-' + a.seriesIndex + ' .nv-distx-' + a.pointIndex).attr('y1', 0),
                                    m.select('.nv-chart-' + c.id() + ' .nv-series-' + a.seriesIndex + ' .nv-disty-' + a.pointIndex).attr('x2', h.size());
                            }),
                            c.dispatch.on('elementMouseover.tooltip', function (a) {
                                m.select('.nv-series-' + a.seriesIndex + ' .nv-distx-' + a.pointIndex).attr('y1', a.pos.top - H - j.top),
                                    m.select('.nv-series-' + a.seriesIndex + ' .nv-disty-' + a.pointIndex).attr('x2', a.pos.left + g.size() - j.left),
                        ...
                        function q() {
                            if (!j) {
                                ...
                                a.exit().transition().duration(250).style('stroke-opacity', 0).style('fill-opacity', 0).remove(),
                                    ...
                                    i.length &&
                                        (b.append('line').attr('x1', 0).attr('y1', -f.top).attr('x2', 0).attr('y2', u),
                                        b.append('text').attr('class', 'nv-xValue').attr('x', -6).attr('y', -f.top).attr('text-anchor', 'end').attr('dy', '.9em'),
                                        z.select('.nv-hoverValue .nv-xValue').text(k(e.x()(p[i[0]], i[0]))),
                                        b.append('text').attr('class', 'nv-yValue').attr('x', 6).attr('y', -f.top).attr('text-anchor', 'start').attr('dy', '.9em'),
                    ...
                    m.each(function (m) {
                        ...
                        D.call(r),
                            ...
                            y
                                ...
                                .attr('width', s)
                                .attr('height', v),
                            C.attr('clip-path', q ? 'url(#nv-edge-clip-' + i + ')' : '');
                        var E = d3.svg
                                .area()
                                .x(function (a, b) {
                                    return c(k(a, b));
                        ...
                        G.enter()
                            ...
                            .on('mouseover', function (a) {
                                d3.select(this).classed('hover', !0), t.areaMouseover({ point: a, series: a.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: a.seriesIndex });
                            })
                            .on('mouseout', function (a) {
                                d3.select(this).classed('hover', !1), t.areaMouseout({ point: a, series: a.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: a.seriesIndex });
                            })
                            .on('click', function (a) {
                                d3.select(this).classed('hover', !1), t.areaClick({ point: a, series: a.key, pos: [d3.event.pageX, d3.event.pageY], seriesIndex: a.seriesIndex });
                            }),
                            G.exit().remove(),
                    ...
                    k.each(function (k) {
                        ...
                        if (
                            ...
                            h.width(Q),
                                ...
                                l.top != h.height() && ((l.top = h.height()), (L = a.utils.availableHeight(n, x, l))),
                                P.select('.nv-legendWrap').attr('transform', 'translate(' + (K - Q) + ',' + -l.top + ')');
                        }
                        if (p) {
                            var R = [
                                { key: B.stacked || 'Stacked', metaKey: 'Stacked', disabled: 'stack' != e.style(), style: 'stack' },
                                { key: B.stream || 'Stream', metaKey: 'Stream', disabled: 'stream' != e.style(), style: 'stream' },
                                { key: B.expanded || 'Expanded', metaKey: 'Expanded', disabled: 'expand' != e.style(), style: 'expand' },
                                { key: B.stack_percent || 'Stack %', metaKey: 'Stack_Percent', disabled: 'stack_percent' != e.style(), style: 'stack_percent' },
                            ];
                            (z = (A.length / 3) * 260),
                                ...
                                l.top != Math.max(i.height(), h.height()) && ((l.top = Math.max(i.height(), h.height())), (L = a.utils.availableHeight(n, x, l))),
                                P.select('.nv-controlsWrap').attr('transform', 'translate(0,' + -l.top + ')');
                        }
                        N.attr('transform', 'translate(' + l.left + ',' + l.top + ')'),
                            t && P.select('.nv-y.nv-axis').attr('transform', 'translate(' + K + ',0)'),
                            u && (j.width(K).height(L).margin({ left: l.left, top: l.top }).svgContainer(x).xScale(c), N.select('.nv-interactive').call(j)),
                            e.width(K).height(L);
                        ...
                        if (
                            ...
                            r &&
                                (f
                                    ...
                                    .tickSize(-L, 0),
                                P.select('.nv-x.nv-axis').attr('transform', 'translate(0,' + L + ')'),
                                P.select('.nv-x.nv-axis').transition().duration(0).call(f)),
                            s)
                        ) {
                            var T;
                            if (
                                ((T = 'wiggle' === e.offset() ? 0 : a.utils.calcTicksY(L / 36, k)),
                        ...
                        e.dispatch.on('areaClick.toggle', function (a) {
                            ...
                            j.dispatch.on('elementMousemove', function (c) {
                                    ...
                                    (k
                                        ...
                                        .forEach(function (f, j) {
                                            ...
                                            if ((null != l && e.highlightPoint(j, g, !0), 'undefined' != typeof k)) {
                                                ...
                                                i.push({ key: f.key, value: m, color: o(f, f.seriesIndex), stackedValue: k.display });
                                            }
                                        }),
                                    i.reverse(),
                                    i.length > 2)
                                ...
                                'expand' === e.style() || 'stack_percent' === e.style() ? (E || (E = q), (q = d3.format('.1%'))) : E && ((q = E), (E = null)),
                                    j.tooltip
                                        .position({ left: h + l.left, top: c.mouseY + l.top })
                            ...
                            y.on('changeState', function (a) {
                                'undefined' != typeof a.disabled &&
                                    ...
                                    'undefined' != typeof a.style && (e.style(a.style), (G = a.style)),
                                    b.update();
                            });
                    }),
                    ...
                    u.each(function (b) {
                        ...
                        var z = l.selectAll('.nv-wrap.nv-sunburst').data(b),
                            A = z
                                .enter()
                                .append('g')
                                .attr('class', 'nvd3 nv-wrap nv-sunburst nv-chart-' + k),
                            B = A.selectAll('nv-sunburst');
                        z.attr('transform', 'translate(' + w / 2 + ',' + x / 2 + ')'),
                            ...
                            (v = B.data(r.nodes)
                                ...
                                .each(t)
                                .on('mouseover', function (a) {
                                    d3.select(this).classed('hover', !0).style('opacity', 0.8), o.elementMouseover({ data: a, color: d3.select(this).style('fill') });
                                })
                                .on('mouseout', function (a) {
