            ...
            return (
                (e.toggle = function () {
                    ...
                    this._element.hasAttribute('disabled') ||
                        ...
                        (e && this._element.setAttribute('aria-pressed', !this._element.classList.contains(_)), t && o.default(this._element).toggleClass(_));
                }),
                (e.dispose = function () {
        ...
        P = (function () {
            ...
            return (
                ...
                (e._slide = function (t, e) {
                    ...
                    if (
                        (t === N ? ((n = 'carousel-item-left'), (i = 'carousel-item-next'), (a = 'left')) : ((n = 'carousel-item-right'), (i = 'carousel-item-prev'), (a = 'right')),
                            ...
                            if (!this._inNavbar && e) {
                                ...
                                'parent' === this._config.reference
                                    ...
                                    : d.isElement(this._config.reference) &&
                                      ((l = this._config.reference), 'undefined' != typeof this._config.reference.jquery && (l = this._config.reference[0])),
                    ...
                    if (!this._element.disabled && !o.default(this._element).hasClass($) && o.default(this._menu).hasClass(J)) {
                        ...
                        o.default(i).trigger(n),
                            n.isDefaultPrevented() ||
                                (this._popper && this._popper.destroy(), o.default(this._menu).toggleClass(J), o.default(i).toggleClass(J).trigger(o.default.Event(tt, e)));
                    }
                }),
                (e.dispose = function () {
                        ...
                        for (var n = [].slice.call(document.querySelectorAll(it)), i = 0, a = n.length; i < a; i++) {
                            ...
                            if ((e && 'click' === e.type && (r.clickEvent = e), l)) {
                                ...
                                if (
                                    ...
                                    !(e && (('click' === e.type && /input|textarea/i.test(e.target.tagName)) || ('keyup' === e.type && 9 === e.which)) && o.default.contains(s, e.target))
                                ) {
                ...
                (t._dataApiKeydownHandler = function (e) {
                    if (
                        !(/input|textarea/i.test(e.target.tagName)
                            ? 32 === e.which || (27 !== e.which && ((40 !== e.which && 38 !== e.which) || o.default(e.target).closest(ot).length))
                            : !Y.test(e.which)) &&
                        !this.disabled &&
                        ...
                        if (i || 27 !== e.which) {
                            if ((e.preventDefault(), e.stopPropagation(), !i || 27 === e.which || 32 === e.which))
                                return 27 === e.which && o.default(n.querySelector(it)).trigger('focus'), void o.default(this).trigger('click');
            ...
            return (
                ...
                (e._activate = function (t) {
                    ...
                    n.hasClass('dropdown-item')
                        ...
                        : (n.addClass(ee), n.parents(ie).prev('.nav-link, .list-group-item').addClass(ee), n.parents(ie).prev('.nav-item').children('.nav-link').addClass(ee)),
        ...
        ge = (function () {
            ...
            return (
                (e.show = function () {
                    ...
                    if (
                        !(
                            (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && o.default(this._element).hasClass(ue)) ||
